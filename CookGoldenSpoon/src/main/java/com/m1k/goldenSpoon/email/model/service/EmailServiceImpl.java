...
import com.m1k.goldenSpoon.email.model.mapper.EmailMapper;
	   ...
	   public int sendEmail(String htmlName, String email) {
	       //6자리 난수 인증번호 생성
	        ...
	        try {
	           ...
	           switch(htmlName) {
	           case "signup" : subject = "[cookGoldenSpoon] 회원가입 인증 번호 입니다."; break;
	           }
	           ...
	           // MimeMessage : JavaMail API에서 메일을 보내는데 사용하는 객체
	            ...
	            mimeMessageHelper.addInline("logo", new ClassPathResource("static/image/logo.png"));
